...
func (d *syncVisibilityDB) Set(key, value []byte) error    { return d.visible.Set(key, value) }
func (d *syncVisibilityDB) Delete(key []byte) error        { return d.visible.Delete(key) }
